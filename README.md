...
>
> **Status:** Version 1.3.6 - Enhanced with native tools integration and improved stability.
...
1. **Add the plugin to your config** (`~/.config/opencode/opencode.json`):
   ...
   ```json
   {
     "plugin": ["opencode-antigravity-auth-remix@1.3.6"]
   }
   ```
